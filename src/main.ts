...
document.querySelector<HTMLDivElement>('#app')!.innerHTML = `
  ...
  <div id="title-page" class="bg-gray-200 dark:bg-black flex items-center justify-center min-h-screen">
    <div class="text-center relative w-full max-w-md">
      <h1 class="text-4xl font-bold text-blue-600 dark:text-blue-400">TODO TODO</h1>
      <p class="text-lg text-gray-700 dark:text-gray-300 mt-4">Ugliest <a class="underline decoration-indigo-500">Menage</a> APP.</p>
      ${getAuthHtml()}
    </div>
  </div>
  ${getModalHtml()}
